// pages/chats/components/LimitControl.jsx

/**
 * Панель управления пагинацией: сколько показывать, сколько фильтром отобрано,
 * и общее число записей (если требуется подсказка).
 */
